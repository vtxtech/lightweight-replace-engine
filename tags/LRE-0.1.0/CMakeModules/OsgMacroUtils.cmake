...
############################################################################################
# this is the common set of command for all the DAC GTEST libraries
#
...
# here we use the command to generate the library    
	...
	IF(OSGNTL_INSTALL_TESTS)
		INSTALL(TARGETS ${TARGET_TARGETNAME} RUNTIME DESTINATION ${OSGNTL_TESTS_INSTALLDIR} )
	ENDIF(OSGNTL_INSTALL_TESTS)
